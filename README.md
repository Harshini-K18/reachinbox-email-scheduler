...
- [ ] Docker PostgreSQL and Redis start successfully
- [ ] Google OAuth works
- [ ] Email/password login works
- [ ] Email/password registration works
- [ ] Compose works
- [ ] Scheduled emails appear in Scheduled
- [ ] Emails move to Sent after processing
...
- [ ] Restart persistence demonstrated
- [ ] `.env` files excluded from Git
- [ ] `node_modules` excluded from Git
- [ ] GitHub repository created
- [ ] Hiring team access granted
...
### 0:00 - 0:30
Show the login screen and sign in.

### 0:30 - 1:30
Show the dashboard and briefly demonstrate:
...
### 2:30 - 3:30
Show the Scheduled tab and then the Sent tab after processing.

Open a sent email and show the Ethereal preview.

### 3:30 - 4:30
Schedule another email in the future.

Stop the backend/worker and restart them.

Show that the scheduled job remains and continues processing.
